...
public final class GridGraphQL {
    ...
    /**
     * Converts common grid.url values into Grid base URL.
     * Example:
    ...
    /**
     * Returns nodeUri for the current session, like:
     *   http://<node-ip>:<port>
    ...
    public static String getNodeUri(RemoteWebDriver driver, String gridUrl) {
        try {
            ...
            if (base == null || base.isBlank()) return "UNKNOWN";
            ...
            // Selenium Grid GraphQL schema supports session(id) { nodeUri } [1](https://mmitacnz-my.sharepoint.com/personal/84213_365kit_co/Documents/Microsoft%20Copilot%20Chat%20Files/SimpleThreadSafeSeleniumFramework.txt)
    ...
    /**
     * Extracts host/IP from nodeUri
     * Example: http://192.168.1.10:5555 -> 192.168.1.10
     */
