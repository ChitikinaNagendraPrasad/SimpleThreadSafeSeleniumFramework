...
/**
 * Embedded H2 database (in-memory) for demo purposes. In real projects, you'd
 * connect to your environment DB/replica with secure creds.
 */
public final class DBUtils
{
    ...
    public static Object[][] fetchLoginData()
    {
        ...
        try (Connection con = pool.getConnection(); PreparedStatement ps = con.prepareStatement(sql); ResultSet rs = ps.executeQuery())
        {
            while (rs.next())
            {
                rows.add(new Object[]
